...
<template>
    <AuthenticatedLayout>
        ...
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-500 mt-0.5 dark:text-gray-400">Manage your administrative profile details and update your password.</p>
        </div>
        ...
        <div class="max-w-4xl space-y-6">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div class="p-6 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-slate-900/50">
                    ...
                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Update your account's profile name and email address.</p>
                </div>
                ...
                <form @submit.prevent="updateProfile" class="p-6 space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Name Field -->
                        <div>
                            <label for="name" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">Name</label>
                            <input 
                                id="name"
                                v-model="profileForm.name" 
                                type="text" 
                                required
                                class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-primary/40 focus:outline-none text-sm transition-all font-medium" 
                            />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                type="password" 
                                class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-primary/40 focus:outline-none text-sm transition-all" 
                            />
