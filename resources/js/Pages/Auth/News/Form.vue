...
<template>
    <AuthenticatedLayout>
        ...
        <div class="mb-6 flex items-center justify-between flex-wrap gap-3">
            <div>
                <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">{{ isEditing ? 'Edit Article' : 'New Article' }}</h1>
                <p class="text-sm text-gray-500 mt-0.5">{{ isEditing ? 'Update the article details below.' : 'Create a new news or media article.' }}</p>
            </div>
            <Link :href="route('admin.news.index')" class="inline-flex items-center gap-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 text-sm font-medium transition-colors">
        ...
        <form @submit.prevent="submit" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-5">
                <div class="bg-white dark:bg-slate-800 rounded-xl p-5 shadow-sm border border-gray-100 dark:border-gray-700">
                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Article Title *</label>
            ...
            <div class="space-y-5">
                <div class="bg-white dark:bg-slate-800 rounded-xl p-5 shadow-sm border border-gray-100 dark:border-gray-700">
                    <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-4">Article Settings</h3>
