...
<head>
    ...
    <title>{{ $meta['title'] ?? config('app.name', 'Makkah Specialist Eye Hospital Ibadan') }}</title>
    ...
    @if(isset($meta))
        ...
        <meta property="og:site_name" content="Makkah Specialist Eye Hospital Ibadan">
    ...
    @else
        ...
        <meta name="twitter:description"
            content="Makkah Specialist Eye Hospital Ibadan provides comprehensive eye exams, cataract surgery, glaucoma management, and 24/7 emergency eye care.">
